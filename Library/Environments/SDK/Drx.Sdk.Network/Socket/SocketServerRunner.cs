...
namespace Drx.Sdk.Network.Socket
{
    ...
    public sealed class SocketServerRunner : IDisposable
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var lw = new Drx.Sdk.Network.Socket.Services.LightweightCommandHandlingService(_builder);
                // 确保位于列表首位
                socketServices.RemoveAll(s => s is Drx.Sdk.Network.Socket.Services.LightweightCommandHandlingService);
