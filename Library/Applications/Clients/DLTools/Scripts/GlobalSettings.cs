    ...
    public class GlobalSettings
    {
        ...
        public GlobalSettings Load()
        {
            try
            {
                ...
                this.AppTheme = cache.AppTheme;
                this.AppDirverHotKey = cache.AppDirverHotKey;
                this.GamePath = cache.GamePath;
                this.AppHotKeyListener = cache.AppHotKeyListener;
                this.AppListenerProcess = cache.AppListenerProcess;
