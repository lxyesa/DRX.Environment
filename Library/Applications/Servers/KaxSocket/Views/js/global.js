...
(function () {
    ...
    (function () {
        ...
        // 构建 topbar 骨架
        function buildTopbarSkeleton() {
            return '<div class="sk-topbar">'
                + '<div class="sk sk-topbar-logo"></div>'
                + '<div class="sk-topbar-nav">'
                + '<div class="sk sk-topbar-nav-item"></div>'
                + '<div class="sk sk-topbar-nav-item"></div>'
                + '<div class="sk sk-topbar-nav-item"></div>'
                + '</div>'
                + '<div class="sk-topbar-actions">'
                + '<div class="sk sk-topbar-btn"></div>'
                + '<div class="sk sk-topbar-btn"></div>'
                + '</div>'
                + '</div>';
        }
        ...
        function buildBodySkeleton(type) {
            switch (type) {
                ...
                case 'login':
                    return '<div class="sk-body"><div class="sk-form-page"><div class="sk sk-form-card">'
                        + '<div class="sk sk-form-title"></div>'
                        + '<div class="sk sk-form-lead"></div>'
                        + '<div class="sk-field"><div class="sk sk-field-label"></div><div class="sk sk-field-input"></div></div>'
                        + '<div class="sk-field"><div class="sk sk-field-label"></div><div class="sk sk-field-input"></div></div>'
                        + '<div class="sk sk-form-btn"></div>'
                        + '<div class="sk sk-form-btn" style="opacity:.5;"></div>'
                        + '</div></div></div>';

                case 'register':
                    return '<div class="sk-body"><div class="sk-form-page"><div class="sk sk-form-card">'
                        + '<div class="sk sk-form-title" style="width:220px;"></div>'
                        + '<div class="sk sk-form-lead"></div>'
                        + '<div class="sk-field"><div class="sk sk-field-label"></div><div class="sk sk-field-input"></div></div>'
                        + '<div class="sk-field"><div class="sk sk-field-label"></div><div class="sk sk-field-input"></div></div>'
                        + '<div class="sk-field"><div class="sk sk-field-label"></div><div class="sk sk-field-input"></div></div>'
                ...
                case 'shop':
                    return '<div class="sk-body">'
                        + '<div class="sk-shop-header">'
                        + '<div class="sk sk-title" style="margin:0 auto 12px;"></div>'
                        + '<div class="sk sk-subtitle" style="margin:0 auto;"></div>'
                        + '</div>'
                        + '<div class="sk-shop-controls">'
                        + '<div class="sk sk-search-box"></div>'
                        + '<div class="sk sk-filter-box"></div>'
                        + '<div class="sk sk-filter-box"></div>'
                        + '</div>'
                        + '<div class="sk-shop-grid">'
                        + '<div class="sk sk-product-card"></div>'
                        + '<div class="sk sk-product-card"></div>'
                        + '<div class="sk sk-product-card"></div>'
                        + '<div class="sk sk-product-card"></div>'
                        + '<div class="sk sk-product-card"></div>'
                ...
                case 'shop_detail':
                    return '<div class="sk-body">'
                        + '<div class="sk sk-text-sm" style="width:140px;margin-bottom:20px;"></div>'
                        + '<div class="sk-detail-layout">'
                        + '<div style="display:flex;flex-direction:column;gap:16px;">'
                        + '<div class="sk sk-detail-image"></div>'
                        + '<div class="sk" style="width:100%;height:80px;border-radius:8px;"></div>'
                        + '</div>'
                        + '<div class="sk-detail-info">'
                        + '<div class="sk sk-detail-name"></div>'
                        + '<div class="sk sk-text-sm" style="width:140px;"></div>'
                        + '<div class="sk sk-detail-desc"></div>'
                        + '<div class="sk sk-detail-price"></div>'
                        + '<div class="sk sk-btn" style="width:100%;"></div>'
                        + '</div>'
                        + '</div>'
                        + '</div>';
                ...
                case 'profile':
                    return '<div class="sk-body">'
                        ...
                        + '<div class="sk" style="width:28px;height:28px;border-radius:4px;"></div>'
                        + '<div><div class="sk" style="width:120px;height:24px;margin-bottom:4px;"></div><div class="sk" style="width:200px;height:12px;"></div></div>'
                        + '</div>'
                        + '<div style="display:flex;gap:8px;"><div class="sk sk-topbar-btn"></div><div class="sk sk-topbar-btn"></div></div>'
                        + '</div>'
                        + '<div class="sk-profile-layout">'
                        + '<div class="sk-profile-card">'
                        + '<div class="sk sk-circle sk-avatar"></div>'
                        + '<div class="sk sk-profile-name"></div>'
                        + '<div class="sk sk-profile-handle"></div>'
                        + '<div class="sk-profile-stats"><div class="sk sk-profile-stat"></div><div class="sk sk-profile-stat"></div><div class="sk sk-profile-stat"></div></div>'
                        + '<div class="sk sk-text-sm" style="width:100%;margin-top:8px;"></div>'
                        + '<div class="sk sk-text-sm" style="width:100%;"></div>'
                        + '<div class="sk sk-text-sm" style="width:80%;"></div>'
                        + '</div>'
                        + '<div class="sk-profile-main">'
                        + '<div class="sk" style="width:100px;height:20px;"></div>'
                        + '<div class="sk sk-field-input"></div>'
                        + '<div class="sk sk-field-input"></div>'
                        + '<div class="sk" style="width:100%;height:72px;border-radius:4px;"></div>'
                        + '<div class="sk sk-field-input"></div>'
                        + '</div>'
                        + '</div>'
                        + '</div>';
                ...
                case 'assetadmin':
                    return '<div class="sk-body">'
                        ...
                        + '<div class="sk-admin-header-left">'
                        + '<div class="sk sk-admin-logo"></div>'
                        + '<div><div class="sk sk-admin-title"></div><div class="sk sk-admin-lead"></div></div>'
                        + '</div>'
                        + '<div style="display:flex;gap:8px;"><div class="sk sk-topbar-btn"></div><div class="sk sk-topbar-btn"></div></div>'
                        + '</div>'
                        + '<div class="sk-admin-layout">'
                        + '<div class="sk-admin-list">'
                        + '<div class="sk" style="width:100%;height:42px;border-radius:4px;margin-bottom:16px;"></div>'
                        + '<div class="sk sk-admin-list-item"></div>'
                        + '<div class="sk sk-admin-list-item"></div>'
                        + '<div class="sk sk-admin-list-item"></div>'
                        + '<div class="sk sk-admin-list-item"></div>'
                        + '<div class="sk sk-admin-list-item"></div>'
                        + '</div>'
                        + '<div class="sk-admin-sidebar">'
                        + '<div class="sk sk-admin-sidebar-card"></div>'
                        + '<div class="sk sk-admin-sidebar-card" style="height:180px;"></div>'
                        + '</div>'
                        + '</div>'
                        + '</div>';

                case '404':
                    return '<div class="sk-body"><div class="sk-error-page">'
                        + '<div class="sk sk-error-code"></div>'
                        + '<div class="sk sk-error-title"></div>'
                        + '<div class="sk sk-error-desc"></div>'
                        + '<div class="sk sk-error-desc" style="width:240px;"></div>'
                        + '<div class="sk-error-actions"><div class="sk sk-btn" style="width:100px;"></div><div class="sk sk-btn" style="width:120px;opacity:.5;"></div></div>'
                        + '</div></div>';

                default:
                    return '<div class="sk-body" style="display:flex;flex-direction:column;gap:16px;padding-top:60px;">'
                        + '<div class="sk sk-title"></div>'
                        + '<div class="sk sk-subtitle"></div>'
                        + '<div class="sk" style="width:100%;height:200px;border-radius:8px;"></div>'
                        + '</div>';
            }
        }
